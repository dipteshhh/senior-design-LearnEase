...
function SignInPageContent() {
  ...
  return (
    <div className="relative min-h-screen overflow-hidden bg-slate-50 px-4 py-10 sm:px-6 lg:px-8">
      <div className="absolute inset-0 -z-10 bg-[radial-gradient(circle_at_top,rgba(15,23,42,0.08),transparent_38%)]" />
      ...
      <div className="mx-auto flex min-h-[calc(100vh-5rem)] w-full max-w-5xl items-center justify-center">
        <div className="w-full max-w-lg">
          ...
          <div className="text-center">
            <div className="mx-auto flex h-16 w-16 items-center justify-center rounded-3xl bg-slate-950 text-white shadow-[0_14px_30px_rgba(15,23,42,0.18)]">
          ...
          <div className="mt-8 rounded-[28px] border border-slate-200 bg-white p-6 shadow-[0_20px_60px_rgba(15,23,42,0.08)] sm:p-8">
            {isSubmitting ? (
                  ...
                  <div className="space-y-4">
                    <div className="flex items-start gap-3">
                      ...
                      <p className="text-sm leading-6 text-slate-700">
                        We only request your name and email — never your Gmail or
                        personal content.
                      </p>
                    </div>
